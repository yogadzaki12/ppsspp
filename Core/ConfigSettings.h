...
struct ConfigSetting {
	...
	ConfigSetting(const char *iniKey, const char *iniImage, const char *iniShape, const char *iniToggle, const char *iniRepeat, const char *iniSwipeUp, const char *iniSwipeDown, const char *iniSwipeLeft, const char *iniSwipeRight, ConfigBlock *configBlock, ConfigCustomButton *v, ConfigCustomButton def, CfgFlag flags) noexcept
		: iniKey_(iniKey), ini2_(iniImage), ini3_(iniShape), ini4_(iniToggle), ini5_(iniRepeat), ini6_(iniSwipeUp), ini7_(iniSwipeDown), ini8_(iniSwipeLeft), ini9_(iniSwipeRight), type_(Type::TYPE_CUSTOM_BUTTON), flags_(flags), offset_((const char *)v - (const char *)configBlock) {
	...
	const char *ini8_ = nullptr;
	const char *ini9_ = nullptr;
