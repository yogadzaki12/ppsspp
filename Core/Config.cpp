...
static const ConfigSetting controlSettings[] = {
	...
	ConfigSetting("Custom0Mapping", "Custom0Image", "Custom0Shape", "Custom0Toggle", "Custom0Repeat", "Custom0SwipeUpMask", "Custom0SwipeDownMask", "Custom0SwipeLeftMask", "Custom0SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 0), {0, 0, 0, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom1Mapping", "Custom1Image", "Custom1Shape", "Custom1Toggle", "Custom1Repeat", "Custom1SwipeUpMask", "Custom1SwipeDownMask", "Custom1SwipeLeftMask", "Custom1SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 1), {0, 1, 0, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom2Mapping", "Custom2Image", "Custom2Shape", "Custom2Toggle", "Custom2Repeat", "Custom2SwipeUpMask", "Custom2SwipeDownMask", "Custom2SwipeLeftMask", "Custom2SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 2), {0, 2, 0, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom3Mapping", "Custom3Image", "Custom3Shape", "Custom3Toggle", "Custom3Repeat", "Custom3SwipeUpMask", "Custom3SwipeDownMask", "Custom3SwipeLeftMask", "Custom3SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 3), {0, 3, 0, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom4Mapping", "Custom4Image", "Custom4Shape", "Custom4Toggle", "Custom4Repeat", "Custom4SwipeUpMask", "Custom4SwipeDownMask", "Custom4SwipeLeftMask", "Custom4SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 4), {0, 4, 0, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom5Mapping", "Custom5Image", "Custom5Shape", "Custom5Toggle", "Custom5Repeat", "Custom5SwipeUpMask", "Custom5SwipeDownMask", "Custom5SwipeLeftMask", "Custom5SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 5), {0, 0, 1, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom6Mapping", "Custom6Image", "Custom6Shape", "Custom6Toggle", "Custom6Repeat", "Custom6SwipeUpMask", "Custom6SwipeDownMask", "Custom6SwipeLeftMask", "Custom6SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 6), {0, 1, 1, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom7Mapping", "Custom7Image", "Custom7Shape", "Custom7Toggle", "Custom7Repeat", "Custom7SwipeUpMask", "Custom7SwipeDownMask", "Custom7SwipeLeftMask", "Custom7SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 7), {0, 2, 1, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom8Mapping", "Custom8Image", "Custom8Shape", "Custom8Toggle", "Custom8Repeat", "Custom8SwipeUpMask", "Custom8SwipeDownMask", "Custom8SwipeLeftMask", "Custom8SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 8), {0, 3, 1, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom9Mapping", "Custom9Image", "Custom9Shape", "Custom9Toggle", "Custom9Repeat", "Custom9SwipeUpMask", "Custom9SwipeDownMask", "Custom9SwipeLeftMask", "Custom9SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 9), {0, 4, 1, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom10Mapping", "Custom10Image", "Custom10Shape", "Custom10Toggle", "Custom10Repeat", "Custom10SwipeUpMask", "Custom10SwipeDownMask", "Custom10SwipeLeftMask", "Custom10SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 10), {0, 0, 2, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom11Mapping", "Custom11Image", "Custom11Shape", "Custom11Toggle", "Custom11Repeat", "Custom11SwipeUpMask", "Custom11SwipeDownMask", "Custom11SwipeLeftMask", "Custom11SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 11), {0, 1, 2, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom12Mapping", "Custom12Image", "Custom12Shape", "Custom12Toggle", "Custom12Repeat", "Custom12SwipeUpMask", "Custom12SwipeDownMask", "Custom12SwipeLeftMask", "Custom12SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 12), {0, 2, 2, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom13Mapping", "Custom13Image", "Custom13Shape", "Custom13Toggle", "Custom13Repeat", "Custom13SwipeUpMask", "Custom13SwipeDownMask", "Custom13SwipeLeftMask", "Custom13SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 13), {0, 3, 2, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom14Mapping", "Custom14Image", "Custom14Shape", "Custom14Toggle", "Custom14Repeat", "Custom14SwipeUpMask", "Custom14SwipeDownMask", "Custom14SwipeLeftMask", "Custom14SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 14), {0, 4, 2, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom15Mapping", "Custom15Image", "Custom15Shape", "Custom15Toggle", "Custom15Repeat", "Custom15SwipeUpMask", "Custom15SwipeDownMask", "Custom15SwipeLeftMask", "Custom15SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 15), {0, 0, 9, false, false}, CfgFlag::PER_GAME),
	ConfigSetting("Custom16Mapping", "Custom16Image", "Custom16Shape", "Custom16Toggle", "Custom16Repeat", "Custom16SwipeUpMask", "Custom16SwipeDownMask", "Custom16SwipeLeftMask", "Custom16SwipeRightMask", SETTING_IDX(g_Config, CustomButton, 16), {0, 1, 9, false, false}, CfgFlag::PER_GAME),
	...
	ConfigSetting("Emotion1Name", SETTING(g_Config, EmotionListName[0]), "Emotion 1", CfgFlag::PER_GAME),
	ConfigSetting("Emotion2Name", SETTING(g_Config, EmotionListName[1]), "Emotion 2", CfgFlag::PER_GAME),
	ConfigSetting("Emotion3Name", SETTING(g_Config, EmotionListName[2]), "Emotion 3", CfgFlag::PER_GAME),
	ConfigSetting("Emotion4Name", SETTING(g_Config, EmotionListName[3]), "Emotion 4", CfgFlag::PER_GAME),
	ConfigSetting("Emotion5Name", SETTING(g_Config, EmotionListName[4]), "Emotion 5", CfgFlag::PER_GAME),
	ConfigSetting("Emotion6Name", SETTING(g_Config, EmotionListName[5]), "Emotion 6", CfgFlag::PER_GAME),
	ConfigSetting("Emotion7Name", SETTING(g_Config, EmotionListName[6]), "Emotion 7", CfgFlag::PER_GAME),
	ConfigSetting("Emotion8Name", SETTING(g_Config, EmotionListName[7]), "Emotion 8", CfgFlag::PER_GAME),
