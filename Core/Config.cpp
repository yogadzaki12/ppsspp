...
static const ConfigSetting controlSettings[] = {
	...
	ConfigSetting("Custom0Mapping", "Custom0Image", "Custom0Shape", "Custom0Toggle", "Custom0Repeat", "Custom0Summary", "Custom0SummaryText", SETTING_IDX(g_Config, CustomButton, 0), {0, 0, 0, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom1Mapping", "Custom1Image", "Custom1Shape", "Custom1Toggle", "Custom1Repeat", "Custom1Summary", "Custom1SummaryText", SETTING_IDX(g_Config, CustomButton, 1), {0, 1, 0, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom2Mapping", "Custom2Image", "Custom2Shape", "Custom2Toggle", "Custom2Repeat", "Custom2Summary", "Custom2SummaryText", SETTING_IDX(g_Config, CustomButton, 2), {0, 2, 0, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom3Mapping", "Custom3Image", "Custom3Shape", "Custom3Toggle", "Custom3Repeat", "Custom3Summary", "Custom3SummaryText", SETTING_IDX(g_Config, CustomButton, 3), {0, 3, 0, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom4Mapping", "Custom4Image", "Custom4Shape", "Custom4Toggle", "Custom4Repeat", "Custom4Summary", "Custom4SummaryText", SETTING_IDX(g_Config, CustomButton, 4), {0, 4, 0, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom5Mapping", "Custom5Image", "Custom5Shape", "Custom5Toggle", "Custom5Repeat", "Custom5Summary", "Custom5SummaryText", SETTING_IDX(g_Config, CustomButton, 5), {0, 0, 1, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom6Mapping", "Custom6Image", "Custom6Shape", "Custom6Toggle", "Custom6Repeat", "Custom6Summary", "Custom6SummaryText", SETTING_IDX(g_Config, CustomButton, 6), {0, 1, 1, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom7Mapping", "Custom7Image", "Custom7Shape", "Custom7Toggle", "Custom7Repeat", "Custom7Summary", "Custom7SummaryText", SETTING_IDX(g_Config, CustomButton, 7), {0, 2, 1, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom8Mapping", "Custom8Image", "Custom8Shape", "Custom8Toggle", "Custom8Repeat", "Custom8Summary", "Custom8SummaryText", SETTING_IDX(g_Config, CustomButton, 8), {0, 3, 1, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom9Mapping", "Custom9Image", "Custom9Shape", "Custom9Toggle", "Custom9Repeat", "Custom9Summary", "Custom9SummaryText", SETTING_IDX(g_Config, CustomButton, 9), {0, 4, 1, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom10Mapping", "Custom10Image", "Custom10Shape", "Custom10Toggle", "Custom10Repeat", "Custom10Summary", "Custom10SummaryText", SETTING_IDX(g_Config, CustomButton, 10), {0, 0, 2, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom11Mapping", "Custom11Image", "Custom11Shape", "Custom11Toggle", "Custom11Repeat", "Custom11Summary", "Custom11SummaryText", SETTING_IDX(g_Config, CustomButton, 11), {0, 1, 2, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom12Mapping", "Custom12Image", "Custom12Shape", "Custom12Toggle", "Custom12Repeat", "Custom12Summary", "Custom12SummaryText", SETTING_IDX(g_Config, CustomButton, 12), {0, 2, 2, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom13Mapping", "Custom13Image", "Custom13Shape", "Custom13Toggle", "Custom13Repeat", "Custom13Summary", "Custom13SummaryText", SETTING_IDX(g_Config, CustomButton, 13), {0, 3, 2, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom14Mapping", "Custom14Image", "Custom14Shape", "Custom14Toggle", "Custom14Repeat", "Custom14Summary", "Custom14SummaryText", SETTING_IDX(g_Config, CustomButton, 14), {0, 4, 2, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom15Mapping", "Custom15Image", "Custom15Shape", "Custom15Toggle", "Custom15Repeat", "Custom15Summary", "Custom15SummaryText", SETTING_IDX(g_Config, CustomButton, 15), {0, 0, 9, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom16Mapping", "Custom16Image", "Custom16Shape", "Custom16Toggle", "Custom16Repeat", "Custom16Summary", "Custom16SummaryText", SETTING_IDX(g_Config, CustomButton, 16), {0, 1, 9, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom17Mapping", "Custom17Image", "Custom17Shape", "Custom17Toggle", "Custom17Repeat", "Custom17Summary", "Custom17SummaryText", SETTING_IDX(g_Config, CustomButton, 17), {0, 2, 9, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom18Mapping", "Custom18Image", "Custom18Shape", "Custom18Toggle", "Custom18Repeat", "Custom18Summary", "Custom18SummaryText", SETTING_IDX(g_Config, CustomButton, 18), {0, 3, 9, false, false, false, ""}, CfgFlag::PER_GAME),
	ConfigSetting("Custom19Mapping", "Custom19Image", "Custom19Shape", "Custom19Toggle", "Custom19Repeat", "Custom19Summary", "Custom19SummaryText", SETTING_IDX(g_Config, CustomButton, 19), {0, 4, 9, false, false, false, ""}, CfgFlag::PER_GAME),
