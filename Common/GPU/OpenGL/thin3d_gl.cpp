...
uint64_t OpenGLContext::GetNativeObject(NativeObject obj, void *srcObject) {
	...
	{
		OpenGLFramebuffer *fb = srcObject ? (OpenGLFramebuffer *)srcObject : (OpenGLFramebuffer *)curRenderTarget_;
	...
	case NativeObject::BOUND_TEXTURE0_IMAGEVIEW:
		return (uint64_t)(uintptr_t)boundTextures_[0];
	case NativeObject::BOUND_TEXTURE1_IMAGEVIEW:
		return (uint64_t)(uintptr_t)boundTextures_[1];
